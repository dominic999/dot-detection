...
from precompute import find_edge_squares, pick_bars, turnGray, findShapes # pyright: ignore[reportImplicitRelativeImport, reportUnknownVariableType]
...
# squares = find_edge_squares(cropped_image)
